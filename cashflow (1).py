...
results = pd.DataFrame({
    ...
    'R²': [r2_test_lr, r2_test_rf, r2_test_xgb],
    'Adjusted R²': [adj_r2_test_lr, adj_r2_test_rf, adj_r2_test_xgb]
})
...
# --------------------------
best_model_name = results_df.loc[results_df['Mean R²'].idxmax(), 'Model']
